...
define('zapp_user_main', ['dart_sdk', 'flutter_sdk'], (function load__zapp_user_main(dart_sdk, flutter_sdk) {
  ...
  var T = {
    ...
    BuildContextTopageContact: () => (T.BuildContextTopageContact = dart.constFn(dart.fnType(main.pageContact, [framework.BuildContext])))(),
  ...
  dart.defineLazy(CT, {
    ...
    get C3() {
      return C[3] = dart.const({
        __proto__: main.pageContact.prototype,
        [Widget_key]: null
      });
    },
    get C5() {
  ...
  main._MyHomePageState = class _MyHomePageState extends framework.State$(main.MyHomePage) {
    ...
    build(context) {
      return new scaffold.Scaffold.new({appBar: new app_bar.AppBar.new({title: new text.Text.new(this.widget.title)}), body: new basic.Center.new({child: new basic.Column.new({mainAxisAlignment: flex.MainAxisAlignment.center, children: T.JSArrayOfWidget().of([C[2] || CT.C2, new text.Text.new(dart.str(this[_counter]), {style: theme.Theme.of(context).textTheme.headlineMedium}), new elevated_button._ElevatedButtonWithIcon.new({onPressed: dart.fn(() => {
                  navigator.Navigator.push(dart.dynamic, context, new page.MaterialPageRoute.new({builder: dart.fn(context => C[3] || CT.C3, T.BuildContextTopageContact())}));
                }, T.VoidTovoid()), icon: new icon.Icon.new(icons.Icons.contact_mail_rounded, {size: 27}), label: new text.Text.new("Page contact")})])})}), floatingActionButton: new floating_action_button.FloatingActionButton.new({onPressed: dart.bind(this, _incrementCounter), tooltip: "Increment", child: C[4] || CT.C4})});
    }
  ...
  main.pageContact = class pageContact extends framework.StatelessWidget {
    static ['_#new#tearOff'](opts) {
      let key = opts && 'key' in opts ? opts.key : null;
      return new main.pageContact.new({key: key});
    }
    build(context) {
      return new scaffold.Scaffold.new({appBar: new app_bar.AppBar.new({title: new text.Text.new("Page contact")}), body: new scroll_view.ListView.new({children: T.JSArrayOfWidget().of([this.ContactCard(), this.ContactCard(), this.ContactCard(), this.ContactCard(), this.ContactCard(), this.ContactCard(), this.ContactCard(), this.ContactCard(), this.ContactCard(), this.ContactCard(), this.ContactCard(), this.ContactCard()])})});
    }
    ContactCard() {
      return new gesture_detector.GestureDetector.new({onTap: dart.fn(() => {
          js.context.callMethod("open", ["https://www.google.com/"]);
        }, T.VoidTovoid()), child: new container.Container.new({width: 150, height: 150, margin: new edge_insets.EdgeInsets.symmetric({vertical: 10}), decoration: new box_decoration.BoxDecoration.new({color: colors.Colors.red, borderRadius: new border_radius.BorderRadius.circular(10)}), child: new basic.Column.new({children: T.JSArrayOfWidget().of([new basic.Align.new({alignment: alignment.Alignment.center, child: new text.Text.new("Curtis Lavallée", {style: new text_style.TextStyle.new({fontSize: 18})})}), new basic.Expanded.new({child: new basic.Padding.new({padding: new edge_insets.EdgeInsets.fromLTRB(20, 15, 20, 15), child: new text.Text.new("N° Téléphone:", {style: new text_style.TextStyle.new({fontSize: 14})})})}), new basic.Expanded.new({child: new basic.Padding.new({padding: new edge_insets.EdgeInsets.fromLTRB(20, 10, 20, 10), child: new text.Text.new("04 49 96 71 90", {style: new text_style.TextStyle.new({fontSize: 14})})})})])})})});
    }
  };
  (main.pageContact.new = function(opts) {
    let key = opts && 'key' in opts ? opts.key : null;
    main.pageContact.__proto__.new.call(this, {key: key});
    ;
  }).prototype = main.pageContact.prototype;
  dart.addTypeTests(main.pageContact);
  dart.addTypeCaches(main.pageContact);
  dart.setMethodSignature(main.pageContact, () => ({
    __proto__: dart.getMethods(main.pageContact.__proto__),
    build: dart.fnType(framework.Widget, [framework.BuildContext]),
    ContactCard: dart.fnType(framework.Widget, [])
  }));
  dart.setLibraryUri(main.pageContact, I[0]);
  ...
  }, '{"version":3,"sourceRoot":"","sources":["/zapp/project/.zapp_entry.dart","/zapp/project/lib/main.dart","/zapp/project/.dart_tool/dartpad/web_plugin_registrant.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AA2CI,IA1BF,iCAAgB;AACd,UAAoB,6BAGD;AAF8B,QAA9B,AAAkB,6BAElB,eAF2B;;AAEL,QAAF,CAApB;;AAEnB,UAAO,AAAQ,uBAAY;AAKvB,QAJK,AAAqC,qBAA7B,qCAAuB,uBAAW,QAAC;AAG9C,UAFC,AAAQ,sBAAW,2BAA2B,CAC/C;;;wBAIL,SAAC,GAAG;AACL,UAAO,AAAQ,uBAAY;AAIvB,QAHC,AAAQ,sBAAW,wBAAwB,CAC5C,AAAE,CAAD,eACD,AAAW,UAAD;;2DAGM,yCACb,SAAC,MAAM,QAAQ,MAAM;AAC1B,cAAO,AAAQ,uBAAY;AAC4B,YAAlD,AAAQ,sBAAW,wBAAwB,CAAC,IAAI;;;EAI3D;;AAEiB;AAQd,MAPD,MAAS,gCACC;AACS,UAAf;6CAEe;AACmB,UAAjB;;IAGvB;;;;;;;;;UC3C4B;AACxB,YAAO,iCACE,sBACA,2CACmB,oCACV,kBACS,kCAEd,2CACe,kCACV,kBACS,uEAGG;IAEhC;;;QApBmB;AAAb,8CAAa,GAAG;;EAAE;;;;;;;;;;IAmCX;;;;;;;;;;;;AAGsB;IAAkB;;;QAd7B;QAAmB;;AAArC,mDAAkB,GAAG;;EAAuB;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AA4B9C,MAPF,cAAS;AAMG,QAAV,iBAAA,AAAQ,iBAAA;;IAEZ;UAG0B;AAOxB,YAAO,oCACG,+BAGC,kBAAK,AAAO,4BAEf,6BAGG,yCAegC,yCACnB,uCAIhB,kBACa,SAAT,yBACW,AAAY,AAAU,eAAnB,OAAO,8BAGV,4DACF;AAIR,kBAHS,uCACV,OAAO,EACP,yCAA2B,QAAC;0CAGxB,kBACE,yCACD,aAEA,kBAAK,+CAME,0EACT,mCACF;IAIf;;;;;;IA9EI,iBAAW;;;EA+EjB;;;;;;;;;;;;;;;;;;UAI+B;AAC3B,YAAO,oCACG,+BACC,kBAAK,yBAER,wCACM,wBACR,oBACA,oBACA,oBACA,oBACA,oBACA,oBACA,oBACA,oBACA,oBACA,oBACA,oBACA;IAIR;;AAGE,YAAO,kDACE;AACqD,UAAvD,AAAQ,sBAAW,QAAQ,CAAC;mCAE5B,oCACE,aACC,aACW,gDAAoB,kBAC3B,6CACI,iCACa,wCAAS,cAE/B,gCACK,wBACR,gCACuB,mCACd,kBACL,2BACO,wCAAoB,UAG/B,+BACS,gCACe,oCAAS,IAAM,IAAM,IAAM,YACxC,kBACL,yBACO,wCAAoB,YAIjC,+BACS,gCACe,oCAAS,IAAM,IAAM,IAAM,YACxC,kBACL,0BACO,wCAAoB;IAQzC;;;QAtE0B;AAAnB,oDAAmB,GAAG;;EAAE;;;;;;;;;;AA/HV,IAArB;EACF;;ECEwB","file":"main.js"}');
  // Exports:
  return {
